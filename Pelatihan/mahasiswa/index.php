...
$data = mysqli_query($conn, "SELECT * FROM mahasiswa INNER JOIN prodi ON mahasiswa.prodi_id = prodi.prodi_id ORDER BY mhs_id DESC");
// var_dump($data);

$dataprodi = mysqli_query($conn, "SELECT * FROM prodi");
?>
<!DOCTYPE html>
